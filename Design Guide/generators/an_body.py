...
def build(A):
    ...
    add(note('<b>The word &ldquo;freewheeling&rdquo; is used for two '
             ...
             'the same pair of switches is still on. Notes written around the '
             'phase-shift full bridge often use the same word for the dead '
             'time, where the current circulates in the body diodes and '
             'delivers nothing. Both circulate current without delivering '
