...
def build(A):
    ...
    add(p('<b>The same network as an op-amp.</b> Figure&nbsp;%(f)s redraws '
          ...
          'is the LED current; the phototransistor turns it into CTR times '
          'as much collector current; and that current makes the FB voltage across '
    ...
    add(fig('an_comp_opamp',
            ...
            'the LED turn the cathode voltage into a current; the '
            'phototransistor gives CTR times that current; R<sub>FB</sub> '
