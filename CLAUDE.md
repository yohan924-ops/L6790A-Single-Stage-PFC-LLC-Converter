...
| **`HISTORY.md`** | 왜 그렇게 정했나 — 근거 · 정오표 · 사고 기록 · 날짜별 타임라인 | 근거가 필요할 때 |
...
| `Design Guide/AN_L6790A_SingleStage_PFC_LLC_ApplicationNote_v1.3.pdf` · `…_KR_v1.3.pdf` | **배포용 AN** 영문 102쪽 · 한국어 92쪽. `an_pdf.py`+`an_body.py` / `an_kr_pdf.py`+`an_kr_body.py`, 수치 전부 `l6790.py`·시트 | v1.3 · **한국어판이 29·30차만큼 뒤처짐** |
