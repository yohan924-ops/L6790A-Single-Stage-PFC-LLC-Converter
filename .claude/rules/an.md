...
- **조건은 빠짐없이**(2026-09-23, 44차): 측정값은 어느 단자에서, 나머지 권선을 어떻게(Open/Short, 센터탭이면 둘 다, 보조 권선), 어떤 신호로 재는지.
  전류·주파수는 어느 입력 전압·부하·라인 위상인지. 쉼표로 이어 붙인 "1차, 2차 Short" 같은 표기 금지. 같은 기호에 두 값을 싣지 않는다(f<sub>sw,max</sub> 225 대 249).
